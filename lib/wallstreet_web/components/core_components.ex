defmodule WallstreetWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WallstreetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WallstreetWeb.Gettext, "errors", msg, opts)
    end
  end
